    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 py-16 sm:py-24 max-w-6xl">
        <div className="space-y-12">
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-md border-white/30 dark:border-slate-700/30 rounded-2xl p-6 max-w-2xl mx-auto">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-200">Complete Privacy Guaranteed</h3>
              </div>
              <p className="text-slate-600 dark:text-slate-400">"AuraTalk doesn't save what you say. Speak freely — we're here to listen, not to log."</p>
            </div>
          </div>
          ...
          <div className="space-y-12">
            <div className="text-center space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-slate-200">What AuraTalk Offers</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-4xl mx-auto leading-relaxed">
                AuraTalk AI is your personal emotional support companion, designed to understand and respond to your feelings with genuine care and empathy.
              </p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card className="bg-purple-50/80 dark:bg-purple-900/20 backdrop-blur-md border-purple-200/50 dark:border-purple-800/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                  ...
                  <p className="text-purple-600 dark:text-purple-300 leading-relaxed">For peaceful moments of reflection and mindfulness.</p>
                </Card>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-6 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Sometimes you just need someone to hear you.</p>
                </Card>
                <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-6 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                  <Lightbulb className="w-12 h-12 text-yellow-500 mx-auto mb-4" />
                  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-3">Advise</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Get thoughtful guidance and practical suggestions.</p>
                </Card>
                <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-6 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                  <TrendingUp className="w-12 h-12 text-green-500 mx-auto mb-4" />
                  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-3">Motivate</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Need a boost? AuraTalk energizes and encourages you.</p>
                </Card>
                <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-6 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Explore deeper spiritual conversations.</p>
                </Card>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Powered by cutting-edge AI that understands context, emotion, and nuance.</p>
              </Card>
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Your conversations are never stored or saved.</p>
              </Card>
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">AuraTalk is always here when you need support.</p>
              </Card>
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                <Heart className="w-16 h-16 text-red-500 mx-auto mb-6" />
                <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-4">Empathetic Responses</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Our AI responds with genuine empathy and emotional intelligence.</p>
              </Card>
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Get immediate emotional support without waiting.</p>
              </Card>
              <Card className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8 text-center hover:scale-105 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Express yourself freely in a judgment-free environment.</p>
              </Card>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-slate-200 mb-6">What People Are Saying</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { text: "AuraTalk has been a game-changer for my mental health. Having someone to talk to anytime, without judgment, has made such a difference.", name: "Sarah M." },
                { text: "The privacy aspect is incredible. I can share my deepest thoughts knowing they won't be stored anywhere. It's truly liberating.", name: "Alex R." },
                { text: "AuraTalk understands me better than I expected. The conversations feel so natural and supportive. Highly recommend!", name: "Jamie L." },
              ].map((testimonial, i) => (
                <Card key={i} className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-white/30 dark:border-slate-700/30 p-8">
