        ...
        <div className="relative z-10 container mx-auto px-4 py-12">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white/40 backdrop-blur-md rounded-2xl p-2 border border-white/30">
              ...
              <Button disabled variant="ghost" className="text-slate-500 cursor-not-allowed rounded-xl">
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-2xl md:text-3xl text-slate-600 mb-4 leading-relaxed">Your AI powered Emotional Companion</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          ...
          <Card className="bg-white/40 backdrop-blur-md border-white/30 p-8 text-center hover:bg-white/60 transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">Different modes</h3>
            <p className="text-slate-600">Use different modes as per your mood with our beautiful interface.</p>
          </Card>
        </div>
        ...
        <div className="text-center space-y-6">
          <div className="flex justify-center space-x-8 text-base text-slate-500">
            <button onClick={() => setCurrentPage('privacy')} className="hover:text-slate-700 transition-colors underline underline-offset-4">
              Privacy Policy
            </button>
            <button onClick={() => setCurrentPage('terms')} className="hover:text-slate-700 transition-colors underline underline-offset-4">
              Terms & Conditions
            </button>
            <a href="mailto:footballarchive29@gmail.com" className="hover:text-slate-700 transition-colors underline underline-offset-4">
              Support
            </a>
          </div>
