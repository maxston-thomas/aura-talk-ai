        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600">AuraTalk - Effective Date: June 12, 2025</p>
            </div>
          </div>
        </div>

        <Card className="bg-white/60 backdrop-blur-md border-white/40 p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <p className="text-slate-700 mb-2">Have a question? We're here to help.</p>
